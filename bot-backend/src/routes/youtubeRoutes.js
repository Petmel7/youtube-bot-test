...
const { fetchUserVideos, fetchVideoComments, refreshUserVideos } = require("../controllers/youtubeController");
...
router.get("/videos/:videoId/comments", isAuthenticated, asyncHandler(fetchVideoComments));
